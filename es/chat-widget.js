...
Inteligencia DeTLeng ayuda a las organizaciones a transformar información en mejores decisiones mediante Analítica, Business Intelligence, Ingeniería de Datos, IA Aplicada e Insights Estratégicos.
...
<li>🔍 Insights de Negocio</li>
<li>🤖 IA Aplicada</li>
<li>📈 Ingeniería de Datos</li>
<li>📞 Contacto</li>
</ul>

💬 Escribe tu pregunta y haré todo lo posible por ayudarte.
  ...
  ">
    ...
    <input
      id="chatInput"
      type="text"
      placeholder="Pregunta sobre Analítica, BI o IA Aplicada..."
      style="
        flex:1;
        padding:8px;
...
chatMessages.innerHTML += `
  <div style="
    ...
    border-radius:8px;
  ">
    <b>Inteligencia DeTLeng IA:</b><br>
...
chatMessages.scrollTop = chatMessages.scrollHeight;
        ...
        chatMessages.innerHTML += `
          <div style="
            ...
            margin-top:10px;
          ">
            No se pudo conectar con el servicio de IA de Inteligencia DeTLeng. Inténtalo de nuevo más tarde.
          </div>
        `;
